  ...
  <thead>
   ...
   <tbody>
    ...
    <th scope="row"><?php echo $i+1; ?></th>
      ...
      <td><a class="nav-link" href="<?php base_url();?>setuju/<?php echo $tugasakhir[$i]['ta_id']?>"><button type="button" class="btn btn-primary btn-sm"onclick="return confirm('Apakah Anda Yakin Menyetujui Permintaan Ini?');">Setujui</button></a></td>
    </tr>
    <?php endfor ; ?>
    </tbody>
    </table>
